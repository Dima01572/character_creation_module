...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                f'{5+randint(-3, -1)}')
    return (f'{char_name} не применил Атака')


def defence(char_name: str, char_class: str) -> str:
    """Приминение способности защита."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Предложение првоести тренировку."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предложение выбор класса героя."""
    approve_choice: str = ''
    char_class: str = ''
    while approve_choice != 'y':
        ...
        approve_choice = input('Нажми (Y), чтобы подтвердить выбор, или любую '
                               'другю кнопку, чтобы выбрать другого '
                               'персонажа ').lower()
    return char_class
